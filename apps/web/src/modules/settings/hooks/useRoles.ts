...
export const DEFAULT_PERMISSIONS: Omit<Permission, "id" | "created_at">[] = [
  ...
  { code: "financeiro:view", label: "Visualizar Accounting", description: "Acessar módulo Accounting", category: "Accounting" },
  { code: "financeiro:create", label: "Criar Transações", description: "Adicionar novas transações", category: "Accounting" },
  { code: "financeiro:edit", label: "Editar Transações", description: "Modificar transações existentes", category: "Accounting" },
  { code: "financeiro:delete", label: "Excluir Transações", description: "Remover transações", category: "Accounting" },
  { code: "financeiro:reconcile", label: "Reconciliar Accounting", description: "Realizar reconciliação contábil", category: "Accounting" },
  { code: "financeiro:export", label: "Exportar Relatórios Accounting", description: "Exportar dados contábeis", category: "Accounting" },
...
export const DEFAULT_ROLES: Omit<Role, "id" | "created_at" | "updated_at">[] = [
  ...
  { name: "accounting",        description: "Gestão contábil completa",                        is_system: false, priority: 70 },
