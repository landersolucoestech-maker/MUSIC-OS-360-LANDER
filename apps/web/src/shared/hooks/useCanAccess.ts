...
const PERMISSION_MATRIX: Record<AppRole, ModuleActions> = {
  ...
  owner:        { catalog: ALL, contracts: ALL, accounting: ALL, artists: ALL, crm: ALL, marketing: ALL, rh: ALL, settings: ALL, admin: [] },
  ...
  marketing_manager: { catalog: READ_ONLY, contracts: READ_ONLY, accounting: READ_EXPORT, artists: READ_ONLY, crm: CRUD, marketing: CRUD_EXPORT, rh: [], settings: [], admin: [] },
  comercial:    { catalog: READ_ONLY, contracts: ["read", "create", "update"], accounting: READ_ONLY, artists: READ_ONLY, crm: CRUD_EXPORT, marketing: READ_ONLY, rh: [], settings: [], admin: [] },
  colaborador:  { catalog: READ_ONLY, contracts: READ_ONLY, accounting: READ_ONLY, artists: READ_ONLY, crm: READ_ONLY, marketing: READ_ONLY, rh: READ_ONLY, settings: [], admin: [] },
  rh_manager:   { catalog: READ_ONLY, contracts: READ_ONLY, accounting: READ_EXPORT, artists: READ_ONLY, crm: READ_ONLY, marketing: [], rh: CRUD_EXPORT, settings: READ_ONLY, admin: [] },
  viewer:       { catalog: READ_ONLY, contracts: READ_ONLY, accounting: READ_ONLY, artists: READ_ONLY, crm: READ_ONLY, marketing: READ_ONLY, rh: READ_ONLY, settings: READ_ONLY, admin: [] },
};
 ...
 *   useCanAccess('accounting', 'read')  // true for all roles with financeiro access
 */
