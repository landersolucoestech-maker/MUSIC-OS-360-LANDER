...
export class UserRepository {
  ...
  create(tenantId: string, data: Partial<UserEntity>) {
    const entity = this.repo.create({ ...data, tenant_id: tenantId } as Partial<UserEntity> & { tenant_id: string });
    return this.repo.save(entity);
  }

  update(tenantId: string, id: string, data: Partial<UserEntity>) {
