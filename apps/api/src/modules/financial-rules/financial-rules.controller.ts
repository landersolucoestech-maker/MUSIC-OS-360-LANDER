...
export class FinancialRulesController {
  ...
  create(@CurrentTenant() t: { id: string }, @CurrentUser() u: any, @Body() dto: CreateFinancialRuleDto) {
  ...
  update(@CurrentTenant() t: { id: string }, @CurrentUser() u: any, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateFinancialRuleDto) {
