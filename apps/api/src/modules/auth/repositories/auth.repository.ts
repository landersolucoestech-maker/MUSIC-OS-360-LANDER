...
export class AuthRepository {
  constructor(
    ...
    private readonly repo: Repository<AuthEntity>,
  ) {}
  ...
  create(tenantId: string, data: Partial<AuthEntity>) {
    const entity = this.repo.create({ ...data, tenant_id: tenantId } as Partial<AuthEntity> & { tenant_id: string });
    return this.repo.save(entity);
  }

  update(tenantId: string, id: string, data: Partial<AuthEntity>) {
