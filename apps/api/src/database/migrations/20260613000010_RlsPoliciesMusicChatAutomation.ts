...
/**
 * Enables tenant RLS for the three MusicChat automation tables.
 *
 * This migration intentionally does not FORCE RLS and does not change columns,
 * constraints, foreign keys, grants, or indexes.
 */
export class RlsPoliciesMusicChatAutomation20260613000010 implements MigrationInterface {
  name = 'RlsPoliciesMusicChatAutomation20260613000010';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    for (const table of RlsPoliciesMusicChatAutomation20260613000010.TABLES) {
