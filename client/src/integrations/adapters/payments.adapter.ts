...
import type { IPaymentsProvider } from "@/integrations/dto";
import { MOCK_MODE } from "@/shared/lib/env";
import { mockPaymentsProvider } from "@/integrations/providers";
...
function resolvePaymentsProvider(): IPaymentsProvider {
  ...
  // import { BackendPaymentsProvider } from "@/integrations/providers/backend/backend-payments.provider";
