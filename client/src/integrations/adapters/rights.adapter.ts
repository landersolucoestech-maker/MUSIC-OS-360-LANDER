 ...
 *
 * Uso:
 *   import { getRightsAdapter } from "@/integrations/adapters/rights.adapter";
 *   const ecad = getRightsAdapter("ecad");
 *   const arrecadacao = await ecad.getArrecadacao("2025-01");
 */

import type { IRightsProvider, RightsEntityId } from "@/integrations/dto";
...
export function getRightsAdapter(entity: RightsEntityId): IRightsProvider {
  ...
  // import { BackendRightsProvider } from "@/integrations/providers/backend/backend-rights.provider";
