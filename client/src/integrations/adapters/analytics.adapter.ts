 ...
 *
 * Uso:
 *   import { analyticsAdapter } from "@/integrations/adapters/analytics.adapter";
 *   analyticsAdapter.track("contrato.created", { tenant_id, user_id });
 */

import type { IAnalyticsProvider } from "@/integrations/dto";
import { MOCK_MODE } from "@/shared/lib/env";
import { mockAnalyticsProvider } from "@/integrations/providers";
