...
import type { ISigningProvider } from "@/integrations/dto";
import { MOCK_MODE } from "@/shared/lib/env";
import { mockSigningProvider } from "@/integrations/providers";
...
function resolveSigningProvider(): ISigningProvider {
  ...
  // import { BackendSigningProvider } from "@/integrations/providers/backend/backend-signing.provider";
