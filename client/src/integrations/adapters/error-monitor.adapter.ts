 ...
 *
 * Uso:
 *   import { errorMonitorAdapter } from "@/integrations/adapters/error-monitor.adapter";
 *   errorMonitorAdapter.captureError(error, { module: "accounting", action: "create" });
 */

import type { IErrorMonitorProvider } from "@/integrations/dto";
import { MOCK_MODE } from "@/shared/lib/env";
import { mockErrorMonitorProvider } from "@/integrations/providers";
