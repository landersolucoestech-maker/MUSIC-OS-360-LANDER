...
function buildSeedData(): Record<string, unknown[]> {
  return {
  artistas: [
    { id: "art-001", user_id: UID, nome_artistico: "Vitória Lunar", nome_civil: "Vitória Carvalho", tipo: "solo", status: "contratado", status_cadastro: "ativo", genero_musical: "Pop", email: "vitoria@musicos360.com.br", telefone: "(11) 99123-4567", cpf_cnpj: "123.456.789-01", foto_url: null, observacoes: "Artista em ascensão, foco em streaming", contrato_id: "ctr-001", manager_nome: "Rafael Santana", manager_contato: "(11) 98000-1234", produtor_executivo: "Lucas Mendes", agencia_booking: "Prime Booking Brasil", label_parceira: "MusicOS 360 Records", banner_url: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=1200&h=300&fit=crop", galeria_urls: ["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400", "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400"], video_apresentacao_url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", documentos: [{ nome: "Press Kit 2025", url: "https://exemplo.com/presskit-vitoria-2025.pdf" }, { nome: "Rider Técnico", url: "https://exemplo.com/rider-vitoria.pdf" }], created_at: NOW, updated_at: NOW },
    ...
    { id: "art-010", user_id: UID, nome_artistico: "Fernanda Lima", nome_civil: "Fernanda Lima Santos", tipo: "solo", status: "onboarding", status_cadastro: "ativo", genero_musical: "Pop", email: "fernanda@email.com.br", telefone: "(11) 91234-5678", cpf_cnpj: "890.123.456-78", foto_url: null, observacoes: "Artista recém-cadastrada via formulário público. Aguardando revisão da equipe.", contrato_id: null, org_slug: "musicos360", created_at: NOW, updated_at: NOW },
  ],
  ...
  lancamentos: [
    { id: "lanc-001", user_id: UID, titulo: "Noite de Luz - Single", tipo: "single", status: "ativo", artista_id: "art-001", data_lancamento: d(-90), distribuidora: "DistroKid BR", plataformas: ["Spotify", "Apple Music", "YouTube Music", "Deezer"], fonograma_ids: ["fono-001"], observacoes: "Single de trabalho do álbum debut", isrc_global: "BRMSC2500001", upc: "860000123456", assets: { audio_master_url: "https://drive.google.com/file/noite-de-luz-master.wav", capa_url: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=3000", video_clipe_url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", letra: "Letra completa da música Noite de Luz...", ficha_tecnica: null, press_release: null, epk_url: null }, cronograma: { data_gravacao: d(-150), data_mix_master: d(-120), data_entrega_distribuidora: d(-100) }, created_at: NOW, updated_at: NOW },
    { id: "lanc-002", user_id: UID, titulo: "Raiz do Nordeste - EP", tipo: "ep", status: "ativo", artista_id: "art-002", data_lancamento: d(-180), distribuidora: "DistroKid BR", plataformas: ["Spotify", "Apple Music", "Deezer"], fonograma_ids: ["fono-002", "fono-007", "fono-012", "fono-017"], observacoes: "EP com 4 faixas autorais", assets: { audio_master_url: "https://drive.google.com/file/raiz-ep-master.wav", capa_url: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=3000", ficha_tecnica: "Produção: Grupo Raiz Nordestina\nGravação: Estúdio Nordeste SP\nMixagem: Carlos Santos\nMasterização: Pro Audio BR" }, cronograma: { data_gravacao: d(-240), data_mix_master: d(-210), data_entrega_distribuidora: d(-190) }, created_at: NOW, updated_at: NOW },
    { id: "lanc-003", user_id: UID, titulo: "Frequência - Álbum", tipo: "album", status: "ativo", artista_id: "art-003", data_lancamento: d(-120), distribuidora: "Believe Music", plataformas: ["Spotify", "Beatport", "SoundCloud", "Apple Music"], fonograma_ids: ["fono-003", "fono-010", "fono-013"], observacoes: "Álbum eletrônico completo", assets: { audio_master_url: "https://drive.google.com/file/frequencia-album-master.zip", capa_url: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=3000", ficha_tecnica: "Produção e mixagem: Marcus Flow\nMasterização: Pro Lab Berlin", press_release: "Marcus Flow lança álbum debut Frequência...", epk_url: "https://drive.google.com/file/marcus-flow-epk.pdf" }, cronograma: { data_gravacao: d(-200), data_mix_master: d(-160), data_entrega_distribuidora: d(-130) }, created_at: NOW, updated_at: NOW },
    { id: "lanc-004", user_id: UID, titulo: "Amor de Interior - Single", tipo: "single", status: "ativo", artista_id: "art-004", data_lancamento: d(-45), distribuidora: "DistroKid BR", plataformas: ["Spotify", "Apple Music", "YouTube Music"], fonograma_ids: ["fono-004"], observacoes: "Primeiro single da artista", assets: { audio_master_url: "https://drive.google.com/file/amor-interior-master.wav", capa_url: null }, created_at: NOW, updated_at: NOW },
    { id: "lanc-005", user_id: UID, titulo: "Bossa 2026 - Álbum", tipo: "album", status: "ativo", artista_id: "art-005", data_lancamento: d(-200), distribuidora: "Sony Music", plataformas: ["Spotify", "Apple Music", "Tidal", "Deezer"], fonograma_ids: ["fono-005", "fono-015"], observacoes: "Álbum instrumental premiado", assets: { audio_master_url: "https://drive.google.com/file/bossa2026-master.zip", capa_url: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=3000", ficha_tecnica: "Produção: Trio Bossa Moderna\nGravação: Abbey Road Studios", press_release: "Trio Bossa Moderna lança Bossa 2026...", epk_url: "https://drive.google.com/file/trio-bossa-epk.pdf" }, cronograma: { data_gravacao: d(-280), data_mix_master: d(-250), data_entrega_distribuidora: d(-210) }, created_at: NOW, updated_at: NOW },
    { id: "lanc-006", user_id: UID, titulo: "Cidade Mágica - Single", tipo: "single", status: "aguardando_distribuicao", artista_id: "art-001", data_lancamento: d(15), distribuidora: "DistroKid BR", plataformas: ["Spotify", "Apple Music", "YouTube Music", "Deezer", "Amazon Music"], fonograma_ids: ["fono-006"], observacoes: "Pre-save em andamento", isrc_global: "BRMSC2500006", assets: { audio_master_url: "https://drive.google.com/file/cidade-magica-master.wav", capa_url: null }, notas_internas: "Aguardando capa 3000x3000 do designer. Entrega prometida até sexta.", cronograma: { data_gravacao: d(-30), data_mix_master: d(-15), data_entrega_distribuidora: d(-3) }, created_at: NOW, updated_at: NOW },
    { id: "lanc-007", user_id: UID, titulo: "Trap do Norte - Single", tipo: "single", status: "ativo", artista_id: "art-008", data_lancamento: d(-30), distribuidora: "DistroKid BR", plataformas: ["Spotify", "YouTube Music", "Amazon Music"], fonograma_ids: ["fono-008"], observacoes: "Parceria com Renan Costa", assets: { audio_master_url: "https://drive.google.com/file/trap-norte-master.wav", capa_url: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=3000" }, created_at: NOW, updated_at: NOW },
    { id: "lanc-008", user_id: UID, titulo: "Sonho Azul - Single", tipo: "single", status: "em_producao", artista_id: "art-004", data_lancamento: d(45), distribuidora: "DistroKid BR", plataformas: ["Spotify", "Apple Music"], fonograma_ids: ["fono-009"], observacoes: "Mixagem em finalização", notas_internas: "Mix deve finalizar até a próxima semana. Capa ainda não solicitada.", cronograma: { data_gravacao: d(-20), data_mix_master: d(5), data_entrega_distribuidora: d(20) }, created_at: NOW, updated_at: NOW },
    { id: "lanc-009", user_id: UID, titulo: "Raiz 2 - EP", tipo: "ep", status: "planejado", artista_id: "art-002", data_lancamento: d(90), distribuidora: "DistroKid BR", plataformas: ["Spotify", "Apple Music", "Deezer"], fonograma_ids: [], observacoes: "Segundo EP em planejamento", created_at: NOW, updated_at: NOW },
    { id: "lanc-010", user_id: UID, titulo: "Flow Noturno - EP", tipo: "ep", status: "ativo", artista_id: "art-003", data_lancamento: d(-270), distribuidora: "Believe Music", plataformas: ["Spotify", "Beatport", "Apple Music"], fonograma_ids: ["fono-010"], observacoes: "EP de deep house", assets: { audio_master_url: "https://drive.google.com/file/flow-noturno-master.zip", capa_url: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=3000", ficha_tecnica: "Produção: Marcus Flow\nMixagem: Digital Lab" }, created_at: NOW, updated_at: NOW },
  ],
...
function patchMockData(data: Record<string, unknown[]>): void {
  ...
  // art-010 — Fernanda Lima (onboarding) — adicionado ao seed em Task #572
  if (artistas && !artistas.find((a) => a.id === "art-010")) {
    artistas.push({ id: "art-010", user_id: UID, nome_artistico: "Fernanda Lima", nome_civil: "Fernanda Lima Santos", tipo: "solo", status: "onboarding", status_cadastro: "ativo", genero_musical: "Pop", email: "fernanda@email.com.br", telefone: "(11) 91234-5678", cpf_cnpj: "890.123.456-78", foto_url: null, observacoes: "Artista recém-cadastrada via formulário público. Aguardando revisão da equipe.", contrato_id: null, org_slug: "musicos360", created_at: new Date().toISOString(), updated_at: new Date().toISOString() });
  }

  // art-001 — Vitória Lunar — patch Perfil 360 (Task #572): novos campos de mídia, relacionamentos e documentos
  if (artistas) {
    const art001 = artistas.find((a) => a.id === "art-001");
    if (art001) {
      if (!art001.manager_nome) art001.manager_nome = "Rafael Santana";
      if (!art001.manager_contato) art001.manager_contato = "(11) 98000-1234";
      if (!art001.produtor_executivo) art001.produtor_executivo = "Lucas Mendes";
      if (!art001.agencia_booking) art001.agencia_booking = "Prime Booking Brasil";
      if (!art001.label_parceira) art001.label_parceira = "MusicOS 360 Records";
      if (!art001.banner_url) art001.banner_url = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=1200&h=300&fit=crop";
      if (!art001.galeria_urls) art001.galeria_urls = ["https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400", "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400"];
