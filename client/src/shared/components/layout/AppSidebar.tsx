...
import {
  LayoutDashboard, Users, FolderKanban, Music, Radio, FileText,
  DollarSign, Calendar, Package, MessageCircle, Contact, Megaphone,
  ChevronDown, ListChecks, ChevronRight, PanelLeftClose, PanelLeft,
  Upload, Shield, AlertTriangle, UserPlus, Briefcase, Share2, Receipt,
  Calculator, Eye, Target, CalendarDays, TrendingUp, FileEdit, Sparkles,
  User, Settings, LogOut, ClipboardCheck, Building2, ChevronsUpDown,
  CheckCircle2, Activity, BarChart,
} from "lucide-react";
                ...
                {item.children.map(child => (
                  ...
                  >
                    <child.icon className={cn(
                      ...
                      isActive(child.href) ? "text-sidebar-primary" : "opacity-50",
                    )} />
