...
export const FLOW_ARTISTA_ONBOARDING: OperationalFlow = {
  ...
  futureIntegrations: [
    "Clerk — criar conta de utilizador para o artista",
...
export const FLOW_TENANT_ONBOARDING: OperationalFlow = {
  ...
  steps: [
    { step: 1, actor: "Owner do Tenant", action: "Registar empresa e criar conta",
      module: "settings", entitiesAffected: ["Tenant"], integrations: ["clerk", "stripe"],
      notes: "FUTURO: Clerk cria organização; Stripe inicia trial." },
    ...
    { step: 3, actor: "Owner do Tenant", action: "Convidar membros da equipa",
      module: "settings", entitiesAffected: [], integrations: ["clerk", "resend"],
  ...
  futureIntegrations: [
    "Clerk — autenticação e gestão de organização multi-tenant",
