...
export const DEFAULT_PERMISSIONS: Omit<Permission, "id" | "created_at">[] = [
  ...
  { code: "financeiro:create", label: "Criar Transações", description: "Adicionar transações", category: "Accounting" },
  { code: "financeiro:edit", label: "Editar Transações", description: "Modificar transações", category: "Accounting" },
