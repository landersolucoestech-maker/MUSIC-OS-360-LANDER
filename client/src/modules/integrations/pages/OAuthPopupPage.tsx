...
const PLATFORMS: Record<string, PlatformConfig> = {
  ...
  onerpm: {
    name: "ONErpm",
    tagline: "para continuar para o ONErpm",
    logo: "1R",
    bgColor: "#1a1a1a",
    accentColor: "#F97316",
    buttonBg: "#F97316",
  ...
  symphonic: {
    name: "Symphonic",
    tagline: "para continuar para o Symphonic",
    logo: "SY",
    bgColor: "#1e1b4b",
    accentColor: "#9333EA",
    buttonBg: "#9333EA",
  ...
  soundon: {
    name: "SoundOn",
    tagline: "para continuar para o SoundOn",
    logo: "SO",
    bgColor: "#010101",
    accentColor: "#fe2c55",
    buttonBg: "#fe2c55",
  ...
  musicpro: {
    name: "MusicPro",
    tagline: "para continuar para o MusicPro",
    logo: "MP",
    bgColor: "#f0fdf4",
    accentColor: "#16A34A",
    buttonBg: "#16A34A",
